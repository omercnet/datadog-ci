  ...
  "tests": [
    {
      ...
      "config": {
        ...
        "headers": {"NEW_HEADER": "NEW VALUE"},
        "locations": ["aws:us-east-1"],
        "mobileApplicationVersion": "version-id",
        "mobileApplicationVersionFilePath": "path/to/application.apk",
...
| `mobileApplicationVersion`         | String           | The ID of an application version to run a Synthetic mobile application test on.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| `mobileApplicationVersionFilePath` | String           | Upload an application as a temporary version for a Synthetic mobile application test.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
